...
if (global.db) setInterval(async () => {
 ...
 console.log(color(figlet.textSync('NovaBot-MD\nVersion',{
font: 'Standard',
...
console.log(color(`║ ` ,'white'), color(`✹ Nova𝙱𝚘𝚝-𝙼𝙳 ✹`, 'gold'))
console.log(color(`╠═════════════════════════╩═════════════════════════╗`, 'white'))
...
console.log(color(`║ `, 'white'), color(`[•]`, 'gold'), color(`Creado     : desarrollo                        ║`, 'white'))
console.log(color(`║ `, 'white'), color(`[•]`, 'gold'), color(`bot         : nuevo                          ║`, 'white'))
console.log(color(`╚═══════════════════════════════════════════════════╝`, 'white'))
